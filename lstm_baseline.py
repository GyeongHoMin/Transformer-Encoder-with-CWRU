...
- 분할 비율 (7:1.5:1.5)
- batch_size (64), optimizer (Adam, lr=0.001), epochs (20)
→ 오직 "모델 구조"만 다르게 (Transformer vs LSTM)
"""

import torch
import torch.nn as nn

# cwru_tst.py의 데이터 준비 함수 재사용
from cwru_tst import load_data, prepare_dataloaders, DATA_PATH
